class MazeGame {
    ...
    drawMaze() {
        ...
        this.ctx.fillText(this.exitEmoji, this.exitX * this.CELL_SIZE + this.CELL_SIZE / 2, this.exitY * this.CELL_SIZE + this.CELL_SIZE / 2);
    }
    ...
    drawCharacter() {
        ...
        this.ctx.textAlign = 'center';
        this.ctx.textBaseline = 'middle';
        this.ctx.fillText(this.charEmoji, this.charX * this.CELL_SIZE + this.CELL_SIZE / 2, this.charY * this.CELL_SIZE + this.CELL_SIZE / 2);
    }
