...
function updateProgress() {
  ...
  const progressValue = ((TOTAL_QUESTIONS - random_questions.length) / TOTAL_QUESTIONS) * 100;
...
const all_questions = [
  ...
  {
    question: 'What creature is said to drain livestock of their blood in Latin American folklore?',
    correct_answer: 'Chupacabra',
    fake_answers: ['Wendigo', 'Jersey Devil', 'Kraken'],
  },
  {
    question: 'Which cryptid is often associated with the forests of the Pacific Northwest?',
    correct_answer: 'Bigfoot',
    fake_answers: ['Mothman', 'Kraken', 'Thunderbird'],
  },
  {
    question: 'What winged creature is said to be a harbinger of disaster in West Virginia?',
  ...
  {
    question: "What Himalayan creature is also known as the 'Abominable Snowman'?",
    correct_answer: 'Yeti',
  ...
  {
    question: 'Which large, human-like cryptid is often reported in the Himalayas?',
    correct_answer: 'Yeti',
  ...
  {
    question: 'Which flying cryptid is said to resemble a dragon and has been sighted in Texas?',
    correct_answer: 'Olitiau',
    fake_answers: ['Ropen', 'Thunderbird', 'Kraken'],
  },
  {
    question: 'Which cryptid is rumored to be a giant fish inhabiting lakes in the Ozarks?',
